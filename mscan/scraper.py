...
def getContractsDict(user_ID): 
	...
	data5 = "inputfelderform=inputfelderform&inputfelderform%3AinputFelder%3AanzMinEingabe="+totalCallsMinutesCH(user_ID)+"&inputfelderform%3AinputFelder%3AanzAnrufeEingabe="+totalCallsNumberCH(user_ID)+"&inputfelderform%3AinputFelder%3Aanteil3NrEingabe="+getTrafficPercentageTop3Numbers(user_ID)+"&inputfelderform%3AinputFelder%3AalterAuswahl="+getUserAgeField(user_ID)+"&inputfelderform%3AinputFelder%3Aj_idt117="+getUserCurrentContractPrice(user_ID)+"&inputfelderform%3AinputFelder%3AproviderFilterSB="+getUserOperator(user_ID)+"&inputfelderform%3AinputFelder%3Aj_idt106_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt127=on&inputfelderform%3AinputFelder%3AaufFestnetzSwisscom=0&inputfelderform%3AinputFelder%3AaufFestnetzUPC=0&inputfelderform%3AinputFelder%3Aj_idt136_collapsed=false&inputfelderform%3AinputFelder%3AaufSwisscom=40&inputfelderform%3AinputFelder%3AaufOrange=30&inputfelderform%3AinputFelder%3AaufSunrise=30&inputfelderform%3AinputFelder%3AaufMbudget=0&inputfelderform%3AinputFelder%3AaufCoopMobile=0&inputfelderform%3AinputFelder%3Aj_idt147_collapsed=false&inputfelderform%3AinputFelder%3AaufAldi=0&inputfelderform%3AinputFelder%3AaufOk=0&inputfelderform%3AinputFelder%3AaufLebara=0&inputfelderform%3AinputFelder%3AaufTalkTalk=0&inputfelderform%3AinputFelder%3AaufYallo=0&inputfelderform%3AinputFelder%3AaufLyca=0&inputfelderform%3AinputFelder%3AaufOrtel=0&inputfelderform%3AinputFelder%3AaufMobileUPC=0&inputfelderform%3AinputFelder%3AaufAndere=0&inputfelderform%3AinputFelder%3Aj_idt169_collapsed=true&inputfelderform%3AinputFelder%3AanzSMSEingabe="+SMS_toCH(user_ID)+"&inputfelderform%3AinputFelder%3AanzTageSMS=30&inputfelderform%3AinputFelder%3Aj_idt212_collapsed=false&inputfelderform%3AinputFelder%3AdatenmengeMBEingabe="+str(dataCH(user_ID))+"&inputfelderform%3AinputFelder%3AintVerwendungAnzTageEingabe=30&inputfelderform%3AinputFelder%3AspeedAuswahl=1.0&inputfelderform%3AinputFelder%3Aj_idt223_collapsed=false&inputfelderform%3AinputFelder%3ASmsAusland="+SMS_toABROAD(user_ID)+"&inputfelderform%3AinputFelder%3Aj_idt253_input="+callsToAbroadLandX(user_ID, 0).get('country')+"&inputfelderform%3AinputFelder%3ALand1FixMin="+callsToAbroadLandX(user_ID, 0).get('duration')+"&inputfelderform%3AinputFelder%3ALand1FixAnzAnr="+callsToAbroadLandX(user_ID, 0).get('number')+"&inputfelderform%3AinputFelder%3ALand1MobMin="+callsToAbroadLandX(user_ID, 0).get('duration')+"&inputfelderform%3AinputFelder%3ALand1MobAnzAnr="+callsToAbroadLandX(user_ID, 0).get('number')+"&inputfelderform%3AinputFelder%3Aj_idt250_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt277_input="+callsToAbroadLandX(user_ID, 1).get('country')+"&inputfelderform%3AinputFelder%3ALand2FixMin="+callsToAbroadLandX(user_ID, 1).get('duration')+"&inputfelderform%3AinputFelder%3ALand2FixAnzAnr="+callsToAbroadLandX(user_ID, 1).get('number')+"&inputfelderform%3AinputFelder%3ALand2MobMin="+callsToAbroadLandX(user_ID, 1).get('duration')+"&inputfelderform%3AinputFelder%3ALand2MobAnzAnr="+callsToAbroadLandX(user_ID, 1).get('number')+"&inputfelderform%3AinputFelder%3Aj_idt274_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt301_input="+callsToAbroadLandX(user_ID, 2).get('country')+"&inputfelderform%3AinputFelder%3ALand3FixMin="+callsToAbroadLandX(user_ID, 2).get('duration')+"&inputfelderform%3AinputFelder%3ALand3FixAnzAnr="+callsToAbroadLandX(user_ID, 2).get('number')+"&inputfelderform%3AinputFelder%3ALand3MobMin="+callsToAbroadLandX(user_ID, 2).get('duration')+"&inputfelderform%3AinputFelder%3ALand3MobAnzAnr="+callsToAbroadLandX(user_ID, 2).get('number')+"&inputfelderform%3AinputFelder%3Aj_idt298_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt325_input="+callsToAbroadLandX(user_ID, 3).get('country')+"&inputfelderform%3AinputFelder%3ALand4FixMin="+callsToAbroadLandX(user_ID, 3).get('duration')+"&inputfelderform%3AinputFelder%3ALand4FixAnzAnr="+callsToAbroadLandX(user_ID, 3).get('number')+"&inputfelderform%3AinputFelder%3ALand4MobMin="+callsToAbroadLandX(user_ID, 3).get('duration')+"&inputfelderform%3AinputFelder%3ALand4MobAnzAnr="+callsToAbroadLandX(user_ID, 2).get('number')+"&inputfelderform%3AinputFelder%3Aj_idt322_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt349_input="+callsToAbroadLandX(user_ID, 4).get('country')+"&inputfelderform%3AinputFelder%3ALand5FixMin="+callsToAbroadLandX(user_ID, 4).get('duration')+"&inputfelderform%3AinputFelder%3ALand5FixAnzAnr="+callsToAbroadLandX(user_ID, 4).get('number')+"&inputfelderform%3AinputFelder%3ALand5MobMin="+callsToAbroadLandX(user_ID, 4).get('duration')+"&inputfelderform%3AinputFelder%3ALand5MobAnzAnr="+callsToAbroadLandX(user_ID, 4).get('number')+"&inputfelderform%3AinputFelder%3Aj_idt346_collapsed=true&inputfelderform%3AinputFelder_activeIndex=0&inputfelderform%3Aj_idt482=&javax.faces.ViewState="+value1+"%3A"+value2
