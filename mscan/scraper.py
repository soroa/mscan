...
def getContractsDict(user_ID): 
	...
	"inputfelderform:inputFelder:aufFestnetzSwisscom":"0",
	...
	# data5 = "inputfelderform=inputfelderform&inputfelderform%3AinputFelder%3AanzMinEingabe="+str(totalCallsMinutesCH(user_ID))+"&inputfelderform%3AinputFelder%3AanzAnrufeEingabe="+str(totalCallsNumberCH(user_ID))+"&inputfelderform%3AinputFelder%3Aanteil3NrEingabe="+str(getTrafficPercentageTop3Numbers(user_ID))+"&inputfelderform%3AinputFelder%3AalterAuswahl="+str(getUserAgeField(user_ID))+"&inputfelderform%3AinputFelder%3Aj_idt117="+str(getUserCurrentContractPrice(user_ID))+"&inputfelderform%3AinputFelder%3AproviderFilterSB="+str(getUserOperator(user_ID))+"&inputfelderform%3AinputFelder%3Aj_idt106_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt127=on&inputfelderform%3AinputFelder%3AaufFestnetzSwisscom=0&inputfelderform%3AinputFelder%3AaufFestnetzUPC=0&inputfelderform%3AinputFelder%3Aj_idt136_collapsed=false&inputfelderform%3AinputFelder%3AaufSwisscom=40&inputfelderform%3AinputFelder%3AaufOrange=30&inputfelderform%3AinputFelder%3AaufSunrise=30&inputfelderform%3AinputFelder%3AaufMbudget=0&inputfelderform%3AinputFelder%3AaufCoopMobile=0&inputfelderform%3AinputFelder%3Aj_idt147_collapsed=false&inputfelderform%3AinputFelder%3AaufAldi=0&inputfelderform%3AinputFelder%3AaufOk=0&inputfelderform%3AinputFelder%3AaufLebara=0&inputfelderform%3AinputFelder%3AaufTalkTalk=0&inputfelderform%3AinputFelder%3AaufYallo=0&inputfelderform%3AinputFelder%3AaufLyca=0&inputfelderform%3AinputFelder%3AaufOrtel=0&inputfelderform%3AinputFelder%3AaufMobileUPC=0&inputfelderform%3AinputFelder%3AaufAndere=0&inputfelderform%3AinputFelder%3Aj_idt169_collapsed=true&inputfelderform%3AinputFelder%3AanzSMSEingabe="+str(SMS_toCH(user_ID))+"&inputfelderform%3AinputFelder%3AanzTageSMS=30&inputfelderform%3AinputFelder%3Aj_idt212_collapsed=false&inputfelderform%3AinputFelder%3AdatenmengeMBEingabe="+str(dataCH(user_ID))+"&inputfelderform%3AinputFelder%3AintVerwendungAnzTageEingabe=30&inputfelderform%3AinputFelder%3AspeedAuswahl=1.0&inputfelderform%3AinputFelder%3Aj_idt223_collapsed=false&inputfelderform%3AinputFelder%3ASmsAusland="+str(SMS_toABROAD(user_ID))+"&inputfelderform%3AinputFelder%3Aj_idt253_input="+str(callsToAbroadLandX(user_ID, 0).get('country'))+"&inputfelderform%3AinputFelder%3ALand1FixMin="+str(callsToAbroadLandX(user_ID, 0).get('duration'))+"&inputfelderform%3AinputFelder%3ALand1FixAnzAnr="+str(callsToAbroadLandX(user_ID, 0).get('number'))+"&inputfelderform%3AinputFelder%3ALand1MobMin="+str(callsToAbroadLandX(user_ID, 0).get('duration'))+"&inputfelderform%3AinputFelder%3ALand1MobAnzAnr="+str(callsToAbroadLandX(user_ID, 0).get('number'))+"&inputfelderform%3AinputFelder%3Aj_idt250_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt277_input="+str(callsToAbroadLandX(user_ID, 1).get('country'))+"&inputfelderform%3AinputFelder%3ALand2FixMin="+str(callsToAbroadLandX(user_ID, 1).get('duration'))+"&inputfelderform%3AinputFelder%3ALand2FixAnzAnr="+str(callsToAbroadLandX(user_ID, 1).get('number'))+"&inputfelderform%3AinputFelder%3ALand2MobMin="+str(callsToAbroadLandX(user_ID, 1).get('duration'))+"&inputfelderform%3AinputFelder%3ALand2MobAnzAnr="+str(callsToAbroadLandX(user_ID, 1).get('number'))+"&inputfelderform%3AinputFelder%3Aj_idt274_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt301_input="+str(callsToAbroadLandX(user_ID, 2).get('country'))+"&inputfelderform%3AinputFelder%3ALand3FixMin="+str(callsToAbroadLandX(user_ID, 2).get('duration'))+"&inputfelderform%3AinputFelder%3ALand3FixAnzAnr="+str(callsToAbroadLandX(user_ID, 2).get('number'))+"&inputfelderform%3AinputFelder%3ALand3MobMin="+str(callsToAbroadLandX(user_ID, 2).get('duration'))+"&inputfelderform%3AinputFelder%3ALand3MobAnzAnr="+str(callsToAbroadLandX(user_ID, 2).get('number'))+"&inputfelderform%3AinputFelder%3Aj_idt298_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt325_input="+str(callsToAbroadLandX(user_ID, 3).get('country'))+"&inputfelderform%3AinputFelder%3ALand4FixMin="+str(callsToAbroadLandX(user_ID, 3).get('duration'))+"&inputfelderform%3AinputFelder%3ALand4FixAnzAnr="+str(callsToAbroadLandX(user_ID, 3).get('number'))+"&inputfelderform%3AinputFelder%3ALand4MobMin="+str(callsToAbroadLandX(user_ID, 3).get('duration'))+"&inputfelderform%3AinputFelder%3ALand4MobAnzAnr="+str(callsToAbroadLandX(user_ID, 2).get('number'))+"&inputfelderform%3AinputFelder%3Aj_idt322_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt349_input="+str(callsToAbroadLandX(user_ID, 4).get('country'))+"&inputfelderform%3AinputFelder%3ALand5FixMin="+str(callsToAbroadLandX(user_ID, 4).get('duration'))+"&inputfelderform%3AinputFelder%3ALand5FixAnzAnr="+str(callsToAbroadLandX(user_ID, 4).get('number'))+"&inputfelderform%3AinputFelder%3ALand5MobMin="+str(callsToAbroadLandX(user_ID, 4).get('duration'))+"&inputfelderform%3AinputFelder%3ALand5MobAnzAnr="+str(callsToAbroadLandX(user_ID, 4).get('number'))+"&inputfelderform%3AinputFelder%3Aj_idt346_collapsed=true&inputfelderform%3AinputFelder_activeIndex=0&inputfelderform%3Aj_idt482=&javax.faces.ViewState="+value1+"%3A"+value2
	# data6= "inputfelderform=inputfelderform&inputfelderform%3AinputFelder%3AanzMinEingabe=29&inputfelderform%3AinputFelder%3AanzAnrufeEingabe=24&inputfelderform%3AinputFelder%3Aanteil3NrEingabe=100&inputfelderform%3AinputFelder%3AalterAuswahl=25&inputfelderform%3AinputFelder%3Aj_idt117=29&inputfelderform%3AinputFelder%3AproviderFilterSB=Sunrise&inputfelderform%3AinputFelder%3Aj_idt106_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt127=on&inputfelderform%3AinputFelder%3AaufFestnetzSwisscom=0&inputfelderform%3AinputFelder%3AaufFestnetzUPC=0&inputfelderform%3AinputFelder%3Aj_idt136_collapsed=false&inputfelderform%3AinputFelder%3AaufSwisscom=40&inputfelderform%3AinputFelder%3AaufOrange=30&inputfelderform%3AinputFelder%3AaufSunrise=30&inputfelderform%3AinputFelder%3AaufMbudget=0&inputfelderform%3AinputFelder%3AaufCoopMobile=0&inputfelderform%3AinputFelder%3Aj_idt147_collapsed=false&inputfelderform%3AinputFelder%3AaufAldi=0&inputfelderform%3AinputFelder%3AaufOk=0&inputfelderform%3AinputFelder%3AaufLebara=0&inputfelderform%3AinputFelder%3AaufTalkTalk=0&inputfelderform%3AinputFelder%3AaufYallo=0&inputfelderform%3AinputFelder%3AaufLyca=0&inputfelderform%3AinputFelder%3AaufOrtel=0&inputfelderform%3AinputFelder%3AaufMobileUPC=0&inputfelderform%3AinputFelder%3AaufAndere=0&inputfelderform%3AinputFelder%3Aj_idt169_collapsed=true&inputfelderform%3AinputFelder%3AanzSMSEingabe=37&inputfelderform%3AinputFelder%3AanzTageSMS=30&inputfelderform%3AinputFelder%3Aj_idt212_collapsed=false&inputfelderform%3AinputFelder%3AdatenmengeMBEingabe=1397&inputfelderform%3AinputFelder%3AintVerwendungAnzTageEingabe=30&inputfelderform%3AinputFelder%3AspeedAuswahl=1.0&inputfelderform%3AinputFelder%3Aj_idt223_collapsed=false&inputfelderform%3AinputFelder%3ASmsAusland=12&inputfelderform%3AinputFelder%3Aj_idt253_input=Italien&inputfelderform%3AinputFelder%3ALand1FixMin=4&inputfelderform%3AinputFelder%3ALand1FixAnzAnr=6&inputfelderform%3AinputFelder%3ALand1MobMin=4&inputfelderform%3AinputFelder%3ALand1MobAnzAnr=6&inputfelderform%3AinputFelder%3Aj_idt250_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt277_input=&inputfelderform%3AinputFelder%3ALand2FixMin=0&inputfelderform%3AinputFelder%3ALand2FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand2MobMin=0&inputfelderform%3AinputFelder%3ALand2MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt274_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt301_input=&inputfelderform%3AinputFelder%3ALand3FixMin=0&inputfelderform%3AinputFelder%3ALand3FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand3MobMin=0&inputfelderform%3AinputFelder%3ALand3MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt298_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt325_input=&inputfelderform%3AinputFelder%3ALand4FixMin=0&inputfelderform%3AinputFelder%3ALand4FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand4MobMin=0&inputfelderform%3AinputFelder%3ALand4MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt322_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt349_input=&inputfelderform%3AinputFelder%3ALand5FixMin=0&inputfelderform%3AinputFelder%3ALand5FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand5MobMin=0&inputfelderform%3AinputFelder%3ALand5MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt346_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt374_input=Italien&inputfelderform%3AinputFelder%3ARoaming1AnzTage=10&inputfelderform%3AinputFelder%3ARoamingSMS=12&inputfelderform%3AinputFelder%3ARoamingDatenMB=12&inputfelderform%3AinputFelder%3ARoamingIncomingMin=0&inputfelderform%3AinputFelder%3ARoamingIncomingAnr=0&inputfelderform%3AinputFelder%3Aj_idt388_collapsed=true&inputfelderform%3AinputFelder%3ARoamingToCHMin=0&inputfelderform%3AinputFelder%3ARoamingToCHAnr=0&inputfelderform%3AinputFelder%3Aj_idt397_collapsed=true&inputfelderform%3AinputFelder%3ARoamingToLocalMin=0&inputfelderform%3AinputFelder%3ARoamingToLocalAnr=0&inputfelderform%3AinputFelder%3Aj_idt406_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land1=&inputfelderform%3AinputFelder%3ARoamingToLand1Min=0&inputfelderform%3AinputFelder%3ARoamingToLand1Anr=0&inputfelderform%3AinputFelder%3Aj_idt415_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land2=&inputfelderform%3AinputFelder%3ARoamingToLand2Min=0&inputfelderform%3AinputFelder%3ARoamingToLand2Anr=0&inputfelderform%3AinputFelder%3Aj_idt428_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land3=&inputfelderform%3AinputFelder%3ARoamingToLand3Min=0&inputfelderform%3AinputFelder%3ARoamingToLand3Anr=0&inputfelderform%3AinputFelder%3Aj_idt441_collapsed=true&inputfelderform%3AinputFelder_activeIndex=4&inputfelderform%3Aj_idt482=&javax.faces.ViewState="+value1+"%3A"+value2
	...
	req = request.post( "http://www.dschungelkompass.ch/mobile/welcomeErweitertesprofil.xhtml' -H 'Host: www.dschungelkompass.ch' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:47.0) Gecko/20100101 Firefox/47.0' -H 'Accept: application/xml, text/xml, */*; q=0.01' -H 'Accept-Language: en-US,en;q=0.5' --compressed -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'Faces-Request: partial/ajax' -H 'X-Requested-With: XMLHttpRequest' -H 'Referer: http://www.dschungelkompass.ch/mobile/welcomeSchnellprofil.xhtml' -H 'Cookie:" + sessionID +"' -H 'Connection: keep-alive' --data 'javax.faces.partial.ajax=true&javax.faces.source=inputfelderform%3AinputFelder%3AanzMinEingabe&javax.faces.partial.execute=inputfelderform%3AinputFelder%3AanzMinEingabe&javax.faces.partial.render=inputfelderform%3AinputFelder%3AdSchnittTel&javax.faces.behavior.event=keyup&javax.faces.partial.event=keyup&inputfelderform=inputfelderform&inputfelderform%3AinputFelder%3AanzMinEingabe=&inputfelderform%3AinputFelder%3AanzAnrufeEingabe=24&inputfelderform%3AinputFelder%3Aanteil3NrEingabe=100&inputfelderform%3AinputFelder%3AalterAuswahl=25&inputfelderform%3AinputFelder%3Aj_idt117=29&inputfelderform%3AinputFelder%3AproviderFilterSB=Sunrise&inputfelderform%3AinputFelder%3Aj_idt106_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt127=on&inputfelderform%3AinputFelder%3AaufFestnetzSwisscom=0&inputfelderform%3AinputFelder%3AaufFestnetzUPC=0&inputfelderform%3AinputFelder%3Aj_idt136_collapsed=false&inputfelderform%3AinputFelder%3AaufSwisscom=40&inputfelderform%3AinputFelder%3AaufOrange=30&inputfelderform%3AinputFelder%3AaufSunrise=30&inputfelderform%3AinputFelder%3AaufMbudget=0&inputfelderform%3AinputFelder%3AaufCoopMobile=0&inputfelderform%3AinputFelder%3Aj_idt147_collapsed=false&inputfelderform%3AinputFelder%3AaufAldi=0&inputfelderform%3AinputFelder%3AaufOk=0&inputfelderform%3AinputFelder%3AaufLebara=0&inputfelderform%3AinputFelder%3AaufTalkTalk=0&inputfelderform%3AinputFelder%3AaufYallo=0&inputfelderform%3AinputFelder%3AaufLyca=0&inputfelderform%3AinputFelder%3AaufOrtel=0&inputfelderform%3AinputFelder%3AaufMobileUPC=0&inputfelderform%3AinputFelder%3AaufAndere=0&inputfelderform%3AinputFelder%3Aj_idt169_collapsed=true&inputfelderform%3AinputFelder%3AanzSMSEingabe=37&inputfelderform%3AinputFelder%3AanzTageSMS=30&inputfelderform%3AinputFelder%3Aj_idt212_collapsed=false&inputfelderform%3AinputFelder%3AdatenmengeMBEingabe=1397&inputfelderform%3AinputFelder%3AintVerwendungAnzTageEingabe=30&inputfelderform%3AinputFelder%3AspeedAuswahl=1.0&inputfelderform%3AinputFelder%3Aj_idt223_collapsed=false&inputfelderform%3AinputFelder%3ASmsAusland=12&inputfelderform%3AinputFelder%3Aj_idt253_input=&inputfelderform%3AinputFelder%3ALand1FixMin=4&inputfelderform%3AinputFelder%3ALand1FixAnzAnr=6&inputfelderform%3AinputFelder%3ALand1MobMin=4&inputfelderform%3AinputFelder%3ALand1MobAnzAnr=6&inputfelderform%3AinputFelder%3Aj_idt250_collapsed=false&inputfelderform%3AinputFelder%3Aj_idt277_input=&inputfelderform%3AinputFelder%3ALand2FixMin=0&inputfelderform%3AinputFelder%3ALand2FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand2MobMin=0&inputfelderform%3AinputFelder%3ALand2MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt274_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt301_input=&inputfelderform%3AinputFelder%3ALand3FixMin=0&inputfelderform%3AinputFelder%3ALand3FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand3MobMin=0&inputfelderform%3AinputFelder%3ALand3MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt298_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt325_input=&inputfelderform%3AinputFelder%3ALand4FixMin=0&inputfelderform%3AinputFelder%3ALand4FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand4MobMin=0&inputfelderform%3AinputFelder%3ALand4MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt322_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt349_input=&inputfelderform%3AinputFelder%3ALand5FixMin=0&inputfelderform%3AinputFelder%3ALand5FixAnzAnr=0&inputfelderform%3AinputFelder%3ALand5MobMin=0&inputfelderform%3AinputFelder%3ALand5MobAnzAnr=0&inputfelderform%3AinputFelder%3Aj_idt346_collapsed=true&inputfelderform%3AinputFelder%3Aj_idt374_input=&inputfelderform%3AinputFelder%3ARoaming1AnzTage=10&inputfelderform%3AinputFelder%3ARoamingSMS=12&inputfelderform%3AinputFelder%3ARoamingDatenMB=12&inputfelderform%3AinputFelder%3ARoamingIncomingMin=0&inputfelderform%3AinputFelder%3ARoamingIncomingAnr=0&inputfelderform%3AinputFelder%3Aj_idt388_collapsed=true&inputfelderform%3AinputFelder%3ARoamingToCHMin=0&inputfelderform%3AinputFelder%3ARoamingToCHAnr=0&inputfelderform%3AinputFelder%3Aj_idt397_collapsed=true&inputfelderform%3AinputFelder%3ARoamingToLocalMin=0&inputfelderform%3AinputFelder%3ARoamingToLocalAnr=0&inputfelderform%3AinputFelder%3Aj_idt406_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land1=&inputfelderform%3AinputFelder%3ARoamingToLand1Min=0&inputfelderform%3AinputFelder%3ARoamingToLand1Anr=0&inputfelderform%3AinputFelder%3Aj_idt415_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land2=&inputfelderform%3AinputFelder%3ARoamingToLand2Min=0&inputfelderform%3AinputFelder%3ARoamingToLand2Anr=0&inputfelderform%3AinputFelder%3Aj_idt428_collapsed=true&inputfelderform%3AinputFelder%3ALandlisteDB_R_Land3=&inputfelderform%3AinputFelder%3ARoamingToLand3Min=0&inputfelderform%3AinputFelder%3ARoamingToLand3Anr=0&inputfelderform%3AinputFelder%3Aj_idt441_collapsed=true&inputfelderform%3AinputFelder_activeIndex=0&javax.faces.ViewState="+value1+"%3A"+value2)
	resultsSouped = BeautifulSoup(req.content)

	# daten = resultsSouped.find_all("input", {"id": "inputfelderform:inputFelder:datenmengeMBEingabe"})
